"""
FAIRGAME slice: Gemma3_12B @ payoff_scale=0.1.
...
Kaggle cell:
    ...
    !rm -rf fairgame-more-at-stake _common.py exp_Gemma3_12B__s0p1.py
    !git clone -q --depth 1 https://github.com/technoob05/fairgame-more-at-stake.git
    !python fairgame-more-at-stake/exp/exp_Gemma3_12B__s0p1.py
"""
