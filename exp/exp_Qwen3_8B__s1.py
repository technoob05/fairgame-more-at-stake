"""
FAIRGAME slice: Qwen3_8B @ payoff_scale=1.0.
...
Kaggle cell:
    ...
    !rm -rf fairgame-more-at-stake _common.py exp_Qwen3_8B__s1.py
    !git clone -q --depth 1 https://github.com/technoob05/fairgame-more-at-stake.git
    !python fairgame-more-at-stake/exp/exp_Qwen3_8B__s1.py
"""
